...
const (
	...
	RandomIntegerNodeID = "https://schemas.yotta.dev/nodes/random/integer/v1"
	RandomNumberNodeID  = "https://schemas.yotta.dev/nodes/random/number/v1"
	RandomBooleanNodeID = "https://schemas.yotta.dev/nodes/random/boolean/v1"
	RandomChoiceNodeID  = "https://schemas.yotta.dev/nodes/random/choice/v1"
	ObserveTimeNodeID   = "https://schemas.yotta.dev/nodes/time/observe/v1"
