...
const (
	FindTemplateMatchesNodeID = "https://schemas.yotta.dev/nodes/vision/find-template-matches/v1"
	CompareImagesNodeID       = "https://schemas.yotta.dev/nodes/vision/compare-images/v1"
	DecodeQRNodeID            = "https://schemas.yotta.dev/nodes/vision/decode-qr/v1"
	AnalyzeColorNodeID        = "https://schemas.yotta.dev/nodes/vision/analyze-color/v1"
	FindColorBlobsNodeID      = "https://schemas.yotta.dev/nodes/vision/find-color-blobs/v1"
