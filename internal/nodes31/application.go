...
const (
	LaunchApplicationNodeID          = "https://schemas.yotta.dev/nodes/application/launch/v1"
	TerminateApplicationNodeID       = "https://schemas.yotta.dev/nodes/application/terminate/v1"
