...
func (r *Runtime) ListWorkflowLibrary(ctx context.Context) ([]workflowinstallation.LibraryEntry, error) {
	if r == nil || r.Installations == nil {
		return nil, errors.New("workflow installation runtime is unavailable")
	}
	return r.Installations.ListLibrary(ctx)
}
...
func (r *Runtime) ApplyStagedWorkflowInstallationUpdate(
	...
	return r.Installations.ApplyStagedUpdate(ctx, token)
}
