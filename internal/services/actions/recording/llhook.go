...
type HookEvent struct {
	...
	MouseBtn    actiontransform.MouseBtn
	IsMouseDown bool
...
func mouseProc(nCode, wParam, lParam uintptr) uintptr {
	if nCode == hcAction && activeEvents != nil {
		...
		switch wParam {
		case wmLButtonDown:
			ev.MouseBtn, ev.IsMouseDown, emit = actiontransform.BtnLeft, true, true
		case wmLButtonUp:
			ev.MouseBtn, ev.IsMouseDown, emit = actiontransform.BtnLeft, false, true
		case wmRButtonDown:
			ev.MouseBtn, ev.IsMouseDown, emit = actiontransform.BtnRight, true, true
		case wmRButtonUp:
			ev.MouseBtn, ev.IsMouseDown, emit = actiontransform.BtnRight, false, true
		case wmMButtonDown:
			ev.MouseBtn, ev.IsMouseDown, emit = actiontransform.BtnMiddle, true, true
		case wmMButtonUp:
			ev.MouseBtn, ev.IsMouseDown, emit = actiontransform.BtnMiddle, false, true
