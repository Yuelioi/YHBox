...
func TestTypedSelectResolvesFromItsConsumerAndExecutesWithoutCoercion(t *testing.T) {
	...
	selectDefinition, _ := builtins.Definition(nodes31.SelectNodeID)
	concatDefinition, _ := builtins.Definition(nodes31.ConcatNodeID)
	source := []byte(fmt.Sprintf(`{
		"format":"yotta.workflow","version":"3.1","workflow":{"id":"wf-select","name":"Select"},
		"revision":0,"entryGraph":"main","graphs":[{"id":"main","kind":"main","nodes":[
			{"id":"select","nodeRef":{"nodeTypeId":%q,"semanticDigest":%q},"position":{"x":0,"y":0},"config":{},
			 "bindings":{"condition":{"kind":"value","value":true},"when_true":{"kind":"value","value":"typed"},"when_false":{"kind":"value","value":"wrong"}}},
			{"id":"concat","nodeRef":{"nodeTypeId":%q,"semanticDigest":%q},"position":{"x":1,"y":0},"config":{},
