export default {
  ...
  inspector: {
    ...
    editor_undo: 'Undo',
    editor_redo: 'Redo',
    editor_comment: 'Toggle comment',
    editor_search: 'Find and replace',
    ...
    dyn_input_source_var: 'Bind variable',
    dyn_input_source_wire: 'Wire',
    dyn_input_wire_hint: 'Value comes from a data wire or literal',
  ...
  error: {
    ...
    BOUND_VAR_UNKNOWN: 'Input {input} binds variable {var} which is not declared in the container',
    BOUND_VAR_TYPE_MISMATCH: 'Input {input} type {want} does not match variable {var} type {got}',
