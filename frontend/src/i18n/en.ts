export default {
  ...
  workflow: {
    ...
    recipes: {
      ...
      analyze_color: {
        title: 'Capture and analyze color',
        description: 'Insert window capture, color coverage, threshold comparison, and branch.',
      },
      find_color_blobs: {
        title: 'Capture and find color blobs',
        description: 'Insert window capture, blob location, count comparison, and branch.',
      },
    },
    connection: {
