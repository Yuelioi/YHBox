export default {
  ...
  assets: {
    ...
    selected_count: '{n} assets selected across pages',
    clear_selection: 'Clear selection',
    ...
    clips: {
      nav_hint: 'Macros, keyboard, and pointer input',
      empty: 'No input recordings yet',
      empty_hint: 'Select an automation target, record input, then save the result to the library.',
