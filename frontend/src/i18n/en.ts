export default {
  ...
  inspector: {
    ...
    editor_snippet_new: 'New snippet…',
    editor_snippet_manage: 'Manage snippets…',
    snippet_manager_title: 'Snippets',
    snippet_manager_new: 'New snippet',
    snippet_manager_name: 'Name',
    snippet_manager_body: 'Snippet body, inserted at the cursor',
    snippet_manager_empty: 'No snippets yet — select code in the editor and save it from the snippets menu',
