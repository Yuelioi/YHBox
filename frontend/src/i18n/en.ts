export default {
  ...
  node: {
    ...
    If: { label: 'If' },
    Loop: { label: 'Loop' },
    Switch: { label: 'Switch (multi-case)' },
    Break: { label: 'Break' },
    Continue: { label: 'Continue' },
    // detect
    WaitTemplate: { label: 'Wait template' },
    CheckTemplate: { label: 'Check template' },
    ClickTemplate: { label: 'Click template' },
    DetectColor: { label: 'Detect color' },
    DetectColorHSV: { label: 'Detect color (HSV)' },
    DualColorBarTrack: { label: 'Dual-color bar track' },
    ROIColorScan: { label: 'ROI color cluster scan' },
    Screenshot: { label: 'Screenshot' },
    // input
    BringGameForeground: { label: 'Bring game to foreground' },
    ClickAt: { label: 'Click at' },
    KeyHoldStart: { label: 'Hold key down' },
    KeyHoldStop: { label: 'Release key' },
    KeyPress: { label: 'Key press' },
    MouseHoldStart: { label: 'Hold mouse down' },
    MouseHoldStop: { label: 'Release mouse' },
    MouseMoveRel: { label: 'Mouse move relative' },
    OnEvent: { label: 'On event' },
    Scroll: { label: 'Mouse scroll' },
    // io
    Log: { label: 'Log' },
    PlayClip: { label: 'Play clip' },
    Toast: { label: 'Toast' },
    // purefunc
    ...
    Neg: { label: 'Negate' },
    Lt: { label: 'Less than' },
    LtEq: { label: 'Less or equal' },
    Gt: { label: 'Greater than' },
    GtEq: { label: 'Greater or equal' },
    Eq: { label: 'Equals' },
    NotEq: { label: 'Not equals' },
    And: { label: 'Logical AND' },
    Or: { label: 'Logical OR' },
    Not: { label: 'Logical NOT' },
    Concat: { label: 'Concatenate' },
    Contains: { label: 'Contains' },
    Length: { label: 'String length' },
    ToString: { label: 'To string' },
    ToNumber: { label: 'To number' },
    ToBool: { label: 'To bool' },
    Select: { label: 'Select (ternary)' },
    // stopwatch
    StopwatchStart: { label: 'Stopwatch start' },
    StopwatchRead: { label: 'Stopwatch read' },
    StopwatchStop: { label: 'Stopwatch stop' },
    // system
    CollapsedNode: { label: 'Collapsed subgraph' },
    CommentBox: { label: 'Comment box' },
    MouseCalibration: { label: 'Mouse calibration' },
    Subgraph: { label: 'Call subgraph' },
    Throw: { label: 'Throw' },
    Try: { label: 'Try / catch' },
    WindowTarget: { label: 'Target window' },
    SubgraphInput: { label: 'Subgraph input' },
    SubgraphOutput: { label: 'Subgraph output' },
    // variable
    GetVar: { label: 'Get variable' },
    SetVar: { label: 'Set variable' },
    IncVar: { label: 'Increment variable' },
    GetParam: { label: 'Get subgraph param' },
    GetSys: { label: 'Get system value' },
  },
  status: {
    idle: 'Idle',
