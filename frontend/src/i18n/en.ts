export default {
  ...
  recordComposable: {
    ...
    leave_during_recording: 'Recording in progress. If you leave, the result cannot auto-wire into the current view — you must go to the target container manually. Leave anyway?',
  },
  subgraphLifecycle: {
