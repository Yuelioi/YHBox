...
export default {
  ...
  workflow: {
    ...
    installation: {
      title: '已安装工作流',
      description: '按安装身份配置本机目标并执行不可变 Release。',
      refresh: '刷新已安装工作流',
      empty: '尚未安装工作流 Release。',
      status_ready: '可运行',
      status_blocked: '需要配置',
      status_archived: '已归档',
      status_unknown: '状态未知',
      readiness_unknown: '尚未取得就绪状态。',
      no_blockers: '运行所需的依赖、目标、凭据和授权均已就绪。',
      blocker_dependency: '缺少依赖 {id}',
      blocker_target: '目标 {id} 未就绪',
      blocker_credential: '凭据 {id} 未绑定',
      'blocker_run-consent': '尚未授权手动运行',
      ...
      update_description:
        '这里只使用已通过验证并缓存在本机的 Release。先预览精确差异，再确认切换；预览令牌只能使用一次。',
      update_candidate: '候选 Release',
      update_candidate_placeholder: '选择本机缓存版本',
      update_empty: '没有可用于常规更新的本机缓存 Release。',
      update_preview: '预览更新',
      ...
      update_permissions: '权限范围差异',
      update_permissions_unchanged: '候选 Release 没有改变精确 capability scope。',
      update_permissions_added: '新增权限',
      update_permissions_removed: '移除权限',
      update_conflicts: '本机配置冲突必须先解决；当前预览不能应用。',
      update_consent_warning:
        '切换会清除该 Installation 的手动与计划运行授权，并持久暂停所有关联的已启用计划。',
      update_blocker_count: '候选 Release 还有 {n} 个就绪阻塞项。',
      update_apply: '确认更新',
      rollback_apply: '确认回退',
      update_reconciliation_title: 'Release 已切换，计划状态需要核对',
      update_reconciliation_description:
        '新的 Release 已提交且旧授权已失效。Yotta 未能确认所有关联计划的持久化或实时重载，请刷新计划页；必要时重启后再核对。',
      settings: '设置',
      run: '运行',
      settings_title: '设置「{name}」',
      settings_description:
        '每个安装拥有独立的目标配置。保存时会按该 Release 的精确 schema 校验，且不会修改 Workflow Source。',
      targets_title: '目标配置',
      targets_empty: '此 Release 不声明本机目标。',
      local_target: '已安装目标',
      select_target: '选择兼容的已安装目标',
      target_required: '必须选择一个已安装目标。',
      target_not_authorized: '未授权',
      target_unavailable: '当前不可用',
      no_compatible_target: '没有已安装且类型兼容的目标。请先在设置中心完成安装与授权。',
      open_target_settings: '打开目标设置',
      profile_settings: '目标 Profile 设置',
      profile_settings_hint: 'JSON 必须满足 Release 内嵌的精确 schema。',
