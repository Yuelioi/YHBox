...
export default {
  ...
  inspector: {
    ...
    dyn_input_source_var: '绑定变量',
    dyn_input_source_wire: '连线',
    dyn_input_wire_hint: '值从数据线或字面量来',
  ...
  error: {
    ...
    BOUND_VAR_UNKNOWN: '输入口 {input} 绑定的变量 {var} 未在容器声明',
    BOUND_VAR_TYPE_MISMATCH: '输入口 {input} 类型 {want} 与变量 {var} 的类型 {got} 不一致',
  ...
  containers: {
    ...
    export_tip: '导出整容器(顶层图 + 全部子图 + 素材打成分享包)',
    delete: {
      title: '删除容器?',
      desc_prefix: '将删除',
      desc_suffix: ', 无法恢复.',
    ...
    toast: {
      ...
      exported: '已导出容器「{name}」到共享库',
      export_failed: '导出容器失败',
    },
