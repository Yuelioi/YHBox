...
export default {
  ...
  settingsMCP: {
    ...
    accessTitle: '能力与权限边界',
    accessHint: '本地 MCP 服务默认只读；执行与写入能力必须由你明确授权。',
    readOnlyTitle: '读取工作区',
    readOnlyHint: '查看容器、节点、资源和诊断信息。',
    executeTitle: '执行与写入',
    executeHint: '运行自动化、驱动输入并修改工作区。',
    alwaysOn: '始终可用',
    enabled: '已授权',
    disabled: '未授权',
    connectionTitle: '连接信息',
    localOnlyHint: '仅监听本机回环地址，不对局域网开放。',
    confirmTitle: '允许 MCP 执行和写入？',
    confirmHint: '连接的 AI 客户端将能运行节点、修改容器并控制鼠标键盘。请只对受信任客户端开启。',
    confirmAction: '确认授权',
  },
  settingsAI: {
    title: 'AI 模型',
