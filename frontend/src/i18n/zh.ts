...
export default {
  ...
  workflow: {
    ...
    list: {
      ...
      management_description: '在一个列表中搜索、筛选和运行所有工作流。',
      new_workflow: '新工作流',
      ...
      bundle_unverified:
        '此文件来源未经验证。导入只会创建可编辑副本，不会自动安装节点包或开始运行。',
    ...
    installation: {
      title: '外部导入工作流',
      description: '为外部导入版本配置本机目标并直接运行。',
      refresh: '刷新外部导入工作流',
      empty: '尚未导入外部工作流。',
      status_ready: '可运行',
      status_blocked: '需要配置',
      status_archived: '已归档',
      status_unknown: '状态未知',
      readiness_unknown: '尚未取得就绪状态。',
      no_blockers: '运行所需的依赖、目标和凭据均已就绪。',
      blocker_dependency: '缺少依赖 {id}',
      blocker_target: '目标 {id} 未就绪',
      blocker_credential: '凭据 {id} 未绑定',
      derive: '编辑副本',
      derive_title: '创建「{name}」的可编辑副本？',
      derive_description:
        '这会创建一个独立的本地可编辑副本。外部导入版本、本机目标、凭据和计划均保持不变；未来版本更新也不会覆盖或合并此副本。',
      derive_confirm: '创建可编辑副本',
      derived_name: '{name}（本地副本）',
      derive_failed: '无法创建可编辑副本',
      update: '更新',
      update_title: '更新「{name}」',
      update_description: '这里只显示已验证并保存在本机的版本。先预览差异，再确认切换。',
      update_candidate: '候选版本',
      update_candidate_placeholder: '选择本机缓存版本',
      update_empty: '没有可用于更新的本机版本。',
      update_preview: '预览更新',
      rollback_preview: '预览回退',
      update_badge: '更新',
      rollback_badge: '回退',
      update_content_changes: '工作流内容',
      update_local_changes: '本机定义',
      update_dependency_changes: '节点依赖',
      update_graphs: '节点图已变化',
      update_resources: 'Workflow Resource 已变化',
      update_variables: '状态变量已变化',
      update_permissions: '运行能力变化',
      update_permissions_unchanged: '候选版本没有改变运行能力需求。',
      update_permissions_added: '新增能力',
      update_permissions_removed: '移除能力',
      update_conflicts: '本机配置冲突必须先解决；当前预览不能应用。',
      update_blocker_count: '候选版本还有 {n} 个待配置项。',
      update_apply: '确认更新',
      rollback_apply: '确认回退',
      update_reconciliation_title: '版本已切换，请刷新确认',
      update_reconciliation_description:
        '新版本已经保存，但最后一次持久化确认未完成。请刷新工作流列表；若状态仍未更新，再重启应用核对。',
      settings: '设置',
      run: '运行',
      settings_title: '设置「{name}」',
      settings_description:
        '每个导入工作流拥有独立的目标配置。保存时会按当前版本的配置格式校验，不会改动工作流内容。',
      targets_title: '目标配置',
      targets_empty: '此版本不需要本机目标。',
      local_target: '已安装目标',
      select_target: '选择兼容的已安装目标',
      target_required: '必须选择一个已安装目标。',
      target_unavailable: '当前不可用',
      no_compatible_target: '没有已配置且类型兼容的目标。请先在设置中心添加一个目标。',
      open_target_settings: '打开目标设置',
      profile_settings: '目标 Profile 设置',
      profile_settings_hint: 'JSON 必须满足当前版本内置的配置格式。',
      settings_json_invalid: '请输入有效的 JSON。',
      settings_object_required: 'Profile 设置必须是 JSON 对象。',
      credentials_title: '安全凭据',
      credentials_empty: '此版本不需要安全凭据。',
      ...
      credentials_secure_hint:
        '这里只保存凭据引用。API Key 始终留在系统安全存储中，不会写入工作流文件或发送给前端。',
    },
    template: {
      windows: {
