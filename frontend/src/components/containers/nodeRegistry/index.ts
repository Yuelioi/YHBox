...
export interface FieldSchema {
  key: string
  label: string
  type: 'select' | 'text' | 'number' | 'bool' | 'key-capture' | 'color-preset' | 'icon-preset'
...
export interface NodeKindSpec {
  ...
  /** Derived from backend DynamicPorts input descriptor. */
  ...
  /** Derived from backend DynamicPorts outputData descriptor. */
