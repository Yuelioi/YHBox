...
func TestGUIControl_ImplementsControl(t *testing.T) {
	var _ runctl.Control = NewGUIControl()
}

func TestGUIControl_InitialState(t *testing.T) {
	c := NewGUIControl()
	if c.IsPaused() {
...
func TestGUIControl_PauseResume(t *testing.T) {
	c := NewGUIControl()
	c.Pause()
	if !c.IsPaused() {
...
func TestGUIControl_StopUnblocksAndSetsBack(t *testing.T) {
	c := NewGUIControl()
	c.Pause()
...
func TestGUIControl_ConcurrentPauseResume(t *testing.T) {
	c := NewGUIControl()
...
func TestGUIControl_Reset(t *testing.T) {
	c := NewGUIControl()
	c.Pause()
	c.Stop()
	if !c.IsBack() {
