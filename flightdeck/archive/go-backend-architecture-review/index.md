---
topic: go-backend-architecture-review
title: "Go backend architecture review"
summary: "Completed Go backend architecture review, implementation program, and release hardening evidence."
---
...
- archive/go-backend-architecture-review/plan.md
- archive/go-backend-architecture-review/review.md
...
- knowledge/build/build.md — 开始编译、测试或静态分析前
