...
| [27 架构恢复与产品纵向闭环](27-architecture-recovery.md) | in_progress | 架构审计 | R5 真机验收打回，纳入 Slices 38–43 后再判定。 |
...
| [37 发布门禁与知识退役](37-release-gate-knowledge-retirement.md) | in_progress | 29–36、38–43 | 自动矩阵完成；等待工作台重构与真机接受。 |
