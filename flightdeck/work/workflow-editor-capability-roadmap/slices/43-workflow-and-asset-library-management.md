...
- Workflow Source 耐久保存 name、description、category、tags，旧 Source 继续合法；元数据修改仍走唯一 authoring patch / CAS 路径。
...
- 工作流搜索覆盖名称、描述、分类、标签和 ID；分类与标签是独立 facet，标签支持多选；分页使用底部数字页码、结果范围和每页数量。
