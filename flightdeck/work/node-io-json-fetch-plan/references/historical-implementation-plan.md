...
> Historical reference only. This proposal predates the current 3.1 Node Contract, capability
> admission model, repository paths, and Flightdeck layout. Re-audit the current Catalog and source
> before using any requirement, command, or checklist item below.
