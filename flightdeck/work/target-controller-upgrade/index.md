...
Current:
- 下一刀：继续健壮性硬化，优先 controller trace error coverage、bundle budget 后续拆分、剩余 widget/schema 语义契约。
