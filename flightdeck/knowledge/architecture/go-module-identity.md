...
READ WHEN: before changing go.mod module identity, Go imports, Wails binding imports, repository ownership/name, or generating bindings after a module move.
