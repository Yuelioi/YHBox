...
READ WHEN: 想给 frameless 独立窗（录制/校准/截图/鼠标检测/悬浮窗 HUD）加圆角、透明或毛玻璃前；升级 Wails 后检查窗口外观能力时
RECHECK WHEN: 升级 Wails；修改 BackgroundType / IgnoreMouseEvents / WebView2CompositionHosting；完成 Win10/Win11 真机 smoke 后
