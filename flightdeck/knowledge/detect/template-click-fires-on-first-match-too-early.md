...
相关前案: [slate-click-up-coords-and-hold-lifecycle.md](../input/slate-click-up-coords-and-hold-lifecycle.md)、[installed-input-authority.md](../architecture/installed-input-authority.md)（都是输入落点/时序; 本案是**检测时序**, 不是落点也不是激活)。
