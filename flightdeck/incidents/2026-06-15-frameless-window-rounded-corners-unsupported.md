---
status: active
when_to_read: 想给 frameless 独立窗 (录制/校准/截图/鼠标检测/悬浮窗 HUD) 加圆角 / 透明 / 毛玻璃前; 调研 wails3 窗口外观能力时
applies_to: [wails, wails3, frameless-window, hud, launcher, border-radius, transparency, backdrop, win10, internal/services/tools/service.go]
