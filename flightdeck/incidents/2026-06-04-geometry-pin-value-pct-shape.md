...
when_to_read: 读/写 Geometry 类型 pin 的值 (前端回填 / 后端校验); 撞"框选/截图设了值但 widget 显示全 0 / 校验永远报 ROI 错"
applies_to: [geometry, pin-value, roi, region, frontend, validator, screen-pick]
---
