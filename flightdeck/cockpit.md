...
3. 两支 smoke 全过 → 归档 work/(移 cold store + design/plan 按日期归档),回 ③ 按 [work/mcp-node-exec/plan.md](work/mcp-node-exec/plan.md) 起 MCP 实现。
...
- **MCP/AI(③)挂账**:A6/C7 polish 余项 + AI 配置待 smoke 项,细节在 cold store `archive/specs/2026-06-23-local-ai-config.md`。AI 系统知识 → [knowledge/nodes/ai-nodes.md](knowledge/nodes/ai-nodes.md) + [knowledge/nodes/held-exec-outputs.md](knowledge/nodes/held-exec-outputs.md)。
