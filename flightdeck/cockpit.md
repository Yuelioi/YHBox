...
Updated: 2026-06-23 · 月离 · Stage: ② AI 节点 epic 实装完成，待真机 smoke
...
用户真机 smoke（`task build` 后，三场景见 ## Pending Review）→ [plan](plans/2026-06-23-ai-nodes.md)。通过则走 landing 归档 spec/plan + graduate spec→docs，再起 ③ MCP。
