...
Focus: **节点逐步调试 + target/controller/Android + MCP 对外暴露大周期已 landing 到本地 `main`**。当前 `main` 顶部为 merge commit `3fed15a merge: land flightdeck debug workflow` 后又补了看板更新，验证已过；本地还未 push。下一步优先做人工复核/发布决策。
