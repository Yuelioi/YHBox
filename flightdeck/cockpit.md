...
- [work/go-backend-architecture-review/](work/go-backend-architecture-review/) — **升级实施中**。审查报告与完整修复方案已完成；批次 A-C 已落地并验证。批次 D 已闭合 backend 的 Win32/Wails seam，并新增 Ubuntu 24.04 amd64 与 macOS 15 arm64 原生 GUI compile gate；下一步观察首次远端运行并设计最小宿主 smoke。
